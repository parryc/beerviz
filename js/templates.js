...
function program1(depth0,data) {
  ...
  buffer += "\n<div class=\"banner-small\">\n  "
    + escapeExpression((helper = helpers.banner || (depth0 && depth0.banner),options={hash:{},data:data},helper ? helper.call(depth0, (data == null || data === false ? data : data.key), options) : helperMissing.call(depth0, "banner", (data == null || data === false ? data : data.key), options)))
    + "\n</div>\n";
